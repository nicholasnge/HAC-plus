...
#             f'--eval --lod 0 --voxel_size 0.001 --update_init_factor 16 --iterations 15_000 --test_iterations 15_000 '
...
for lmbda in [0.004]:  # Optionally, you can try: 0.003, 0.002, 0.001, 0.0005
    for cuda, scene in enumerate(['Truck', 'Train']):
        ...
        one_cmd = f'python train.py -s C:/Users/Nicholas/Desktop/3DGSDATASETS/tandt_intermediate/{scene} --eval --lod 0 --voxel_size 0.01 --update_init_factor 16 --iterations 5_000 --test_iterations 5_000 -m outputs/tandt/{scene}/{lmbda} --lmbda {lmbda} --mask_lr_final {mask_lr_final}'
        os.system(one_cmd)
